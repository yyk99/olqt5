...
using namespace ol;
using namespace ol::sphere;

//describe('ol/sphere', function() {
//
//  describe('getDistance()', function() {
TEST(ol_sphere, getDistance)
{
    //
    //    const expected = [{
    //      c1: [0, 0],
    ...
    //      distance: 0
    {
        std::vector<number_t> c1 = { 0, 0 };
        std::vector<number_t> c2 = { 0, 0 };

        EXPECT_EQ(0, getDistance(c1, c2));
    }
    //    }, {
    //      c1: [0, 0],
    //      c2: [45, 45],
    ...
    {
        std::vector<number_t> c1 = { 0, 0 };
        std::vector<number_t> c2 = { 45, 45 };

        EXPECT_NEAR(6671704.814011975, getDistance(c1, c2), 1e-6);
    }
    //    }, {
    //      c1: [0, 0],
    //      c2: [-45, 45],
    ...
    //      distance: 0
    {
        std::vector<number_t> c1 = { 45, 45 };
        std::vector<number_t> c2 = { 45, 45 };

        EXPECT_NEAR(0, getDistance(c1, c2), 1e-6);
    }
    ...
    //      distance: 13343409.628023949
    {
        std::vector<number_t> c1 = { 45, 45 };
        std::vector<number_t> c2 = { -45, -45 };
        EXPECT_NEAR(13343409.628023949, getDistance(c1, c2), 1e-6);
    }
    ...
    //      distance: 10007557.221017962
    {
        std::vector<number_t> c1 = { 45, 45 };
        std::vector<number_t> c2 = { 45, -45 };
        EXPECT_NEAR(10007557.221017962, getDistance(c1, c2), 1e-6);
    }
    //    }, {
    //      c1: [-45, 45],
    //      c2: [-45, 45],
