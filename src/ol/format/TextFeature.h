#ifndef OL_FOIRMAT_TEXTFEATURE_H
#define OL_FOIRMAT_TEXTFEATURE_H
///**
...
#include "../format/FormatType.h"

#include "../Feature.h" // yyk
...
class OLQT_EXPORT TextFeature : public FeatureFormat {
public:
    TextFeature() {}
    //
    //
    ...
    virtual FormatType::_type getType() const {
        return FormatType::TEXT;
    }
...
#endif // OL_FOIRMAT_TEXTFEATURE_H
