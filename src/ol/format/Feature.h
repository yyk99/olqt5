#ifndef OL_FORMAT_FEATURE_H
#define OL_FORMAT_FEATURE_H
///**
...
// * @api
// */
class OLQT_EXPORT FeatureFormat {
    ...
    virtual FormatType::_type getType() const = 0;
    //
    //
    ///**
