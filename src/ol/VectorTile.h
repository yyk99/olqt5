#ifndef OL_VECTORTILE_H
#define OL_VECTORTILE_H
///**
 ...
 */
class OLQT_EXPORT VectorTile : public Tile {
public:
    //const VectorTile = function(tileCoord, state, src, format, tileLoadFunction, opt_options) {
    VectorTile(ol::tilecoord::TileCoord const &tileCoord, void *state, std::string src, ol::format::FeatureFormat const &format, void *tileLoadFunction, void *opt_options) {
        //
