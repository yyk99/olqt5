#ifndef OL_STRUCTS_LRUCACHE_H
#define OL_STRUCTS_LRUCACHE_H
...
template <class T>
class LRUCache : public ol::events::EventTarget
{
private:
    int m_highWaterMark;
    int count_;
...
public:
    LRUCache(int opt_highWaterMark = 2048)
    {
        ...
        m_highWaterMark = opt_highWaterMark;
        //
        //  /**
        //   * @private
        //   * @type {number}
    ...
    bool canExpireCache() const
    {
        return getCount() > m_highWaterMark;
    }
    //
    //
    ///**
    ...
    std::vector<std::string> getKeys() {
        std::vector<std::string> keys; keys.reserve (this->count_);
        // TODO: implement
