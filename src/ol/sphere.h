 ...
 * @type {number}
 */
number_t const DEFAULT_RADIUS = 6371008.8;
 ...
 * @api
 */
OLQT_EXPORT number_t getDistance(std::vector<number_t> const &c1, std::vector<number_t> const &c2, number_t opt_radius = DEFAULT_RADIUS);
